"""
Django settings for E_P_p project.
...
ALLOWED_HOSTS = ['artistic-creativity-center.onrender.com', "127.0.0.1" ]
...
WSGI_APPLICATION = 'E_P_p.wsgi.application'
